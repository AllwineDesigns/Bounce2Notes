...

{
    ...
    [_delegate readNoteOff:channel parameter1:p1 parameter2:p2 deltaTime:deltaTime track:track];
}
...
- (void) readNoteOn: (UInt8) channel parameter1: (UInt8) p1 parameter2: (UInt8) p2 deltaTime:(UInt32)deltaTime track:(UInt16)track
{
    ...
    [_delegate readNoteOn:channel parameter1:p1 parameter2:p2 deltaTime:deltaTime track:track];
}
    ...
    @try
    {
        ...
        for(UInt16 track = 0; track < trackCount; track++)
        {
            ...
            while(offset < trackEnd)
            {
                ...
                [self.log appendFormat:@"  (%05lu): ", deltaTime];
                ...
                else
                {
                    ...
                    switch (eventType)
                    {
                        case CHANNEL_NOTE_OFF:
                            ...
                            [self readNoteOff: channel parameter1: p1 parameter2: p2 deltaTime:deltaTime track:track];
                            break;
                        ...
                        case CHANNEL_NOTE_ON:
                            ...
                            [self readNoteOn:channel parameter1:p1 parameter2:p2 deltaTime:deltaTime track:track];
                            break;
