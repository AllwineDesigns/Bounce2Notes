...
@implementation ChipmunkSimulationStationaryShader
...
//    NSArray* images = [NSArray arrayWithObjects:@"ball.jpg", @"ball512.jpg", @"ball256.jpg", @"ball128.jpg", @"ball64.jpg", @"ball32.jpg", @"ball16.jpg", @"ball8.jpg", @"ball4.jpg", @"ball2.jpg", @"ball1.jpg", nil];
    ...
    NSArray* images = [NSArray arrayWithObjects:@"stationary.png", nil];
...
//    glGenerateMipmap(GL_TEXTURE_2D);
    ...
    return [self initWithShaderPaths:@"StationaryShader" fragShader:@"StationaryShader"];
}
...
-(void)updateAttributes {
    ...
    for(unsigned int i = 0; i < numParticles; i++) {
        unsigned int quad = 4*numStationary;
        unsigned int tris = 6*numStationary;
        ...
        bool isStationary = ballData->stationary;
    ...
    glVertexAttribPointer(ATTRIB_VERTEX, 2, GL_FLOAT, 0, sizeof(ChipmunkStationaryVertex), &vertices[0]);

    glVertexAttribPointer(ATTRIB_COLOR, 4, GL_FLOAT, 0, sizeof(ChipmunkStationaryVertex), (char*)(&vertices[0])+sizeof(vec2));
    glVertexAttribPointer(ATTRIB_UV, 2, GL_FLOAT, 0, sizeof(ChipmunkStationaryVertex), (char*)(&vertices[0])+sizeof(vec2)+sizeof(vec4));
...
-(void)draw {
    ...
    glDrawElements(GL_TRIANGLES, 6*numStationary, GL_UNSIGNED_INT, &indices[0]);
